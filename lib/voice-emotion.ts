/** When Karen should sound warmer — brief chuckle on jokes, not constant theatrics. */
...
export function shouldChuckle(text: string): boolean {
...
export function ttsInstructionsFor(text: string): string | null {
...
export function speechEmotionFor(text: string): SpeechEmotion {
